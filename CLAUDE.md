# Working on Block Escape

Klotski for Wear OS watches, in Kotlin and Jetpack Compose: the sliding block puzzle
also known as Huarong Pass, where ten blocks packed into a 4x5 tray must be slid until
the 2x2 commander can leave through the gate. Everything runs on the watch - no phone,
no network, no account. `README.md` says what the app is; this file is how work is
done here. Longer procedures live in `.claude/skills/`.

## How the code is laid out

One Gradle module, `:wear`, under `com.dchernykh.klotski`:
...
| `KlotskiViewModel.kt` | the hub between the rules and the screen |
