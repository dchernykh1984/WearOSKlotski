...
android {
    namespace = "com.dchernykh.klotski"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.dchernykh.klotski"
    ...
    reports {
        filters {
            excludes {
                ...
                packages("com.dchernykh.klotski.ui", "com.dchernykh.klotski.store")
                classes("com.dchernykh.klotski.MainActivity*")
            }
        }
        verify {
            rule {
